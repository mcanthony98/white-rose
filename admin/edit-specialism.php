...
$sid = $_GET['id'];
$res=$conn->query("SELECT * FROM specialism WHERE specialism_id='$sid' ORDER BY specialism_id DESC");
$row = $res->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Specialism </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Specialism Edit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12 mx-auto">
          <div class="card card-primary">
            ...
            <div class="card-footer">
                <input type="submit" value="Update Specialism" name="edit-specialism" class="btn btn-success float-right mr-3">
                </form>
            </div>
          </div>
          <!-- /.card -->
        ...
        <div class="col-md-12">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form method="post" action="processes.php" enctype="multipart/form-data">
                           <input type="hidden" name="edit-spec-img" value="<?php echo $sid;?>" >
                        <div>
