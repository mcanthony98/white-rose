  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Specialism </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Specialism Add</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <form method="post" action="processes.php" enctype="multipart/form-data">
              <div class="form-group">
                <label for="inputName">Specialism Name</label>
            ...
            <div class="card-footer">
                <input type="submit" value="Add Specialism" name="new-specialism" class="btn btn-success float-right mr-3">
                </form>
            </div>
          </div>
          <!-- /.card -->
